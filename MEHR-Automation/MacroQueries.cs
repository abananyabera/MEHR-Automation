...
namespace MEHR_Automation
{
    public class MacroQueries
    {
        ...
        public void Add_Counts_by_Datasource(SqlConnection sqlconnection)
        {
            ...
            Console.WriteLine("\n Add_Counts_by_Datasource MacroQueries is completed .\n");
        ...
        { 
            ...
            SqlDataReader datareader = executeQueries.ExecuteQuery(Query, sqlconnection);
            Console.WriteLine("{0,-15} | {1,-15}", datareader.GetName(0), datareader.GetName(1));
            while (datareader.Read())
            {
                Console.WriteLine("{0,-15} | {1,-15}", datareader[0], datareader[1]);
            }
        ...
        public void Removed_Countby_DataSource(SqlConnection sqlconnection)
        {
            ...
            SqlDataReader datareader = executeQueries.ExecuteQuery(Query, sqlconnection);
            Console.WriteLine("{0,-15} | {1,-15} | {2,-15} | {3,-15} | {4,-15}", datareader.GetName(0), datareader.GetName(1), datareader.GetName(2), datareader.GetName(3),datareader.GetName(4));
            while (datareader.Read())
            {
                Console.WriteLine("{0,-15} | {1,-15} | {2,-15} | {3,-15} | {4,-15}", datareader[0], datareader[1], datareader[2], datareader[3], datareader[4]);
            }
        ...
        public void Missing_Email_Types(SqlConnection sqlconnection) 
        {
            ...
            SqlDataReader datareader = executeQueries.ExecuteQuery(Query, sqlconnection);
            Console.WriteLine("{0,-15} | {1,-15} | {2,-15} | {3,-15} | {4,-15}| {5,-15} | {6,-15}| {7,-15}", datareader.GetName(0), datareader.GetName(1), datareader.GetName(2), datareader.GetName(3), datareader.GetName(4), datareader.GetName(5), datareader.GetName(6), datareader.GetName(7));
            if (!datareader.HasRows)
            {
                while (datareader.Read())
                {
                    Console.WriteLine("{0,-15} | {1,-15} | {2,-15} | {3,-15} | {4,-15}| {5,-15} | {6,-15} | {7,-15}", datareader[0], datareader[1], datareader[2], datareader[3], datareader[4], datareader[5], datareader[6], datareader[7]);

                }
            }
            else
            {
                Console.WriteLine(" ## We are having the records in the 'Missing_Email_Types' please validate Manually ## ");
            }
        ...
        public void Coastal_Manager_Duplicates(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine(" ## we should not get here because ' 44 'it is the old datasourceis we are not usig now ## ");
            }
        ...
        public void Danisco_in_Workday_Duplicates(SqlConnection sqlconnection)
        {
            ...
            SqlDataReader datareader = executeQueries.ExecuteQuery(Query, sqlconnection);
            Console.WriteLine("{0,-15} | {1,-15} | {2,-15} | {3,-15} | {4,-15}| {5,-15} | {6,-15} | {7,-15} | {8,-15}", datareader.GetName(0), datareader.GetName(1), datareader.GetName(2), datareader.GetName(3), datareader.GetName(4), datareader.GetName(5), datareader.GetName(6), datareader.GetName(7), datareader.GetName(8));
            if (!datareader.HasRows)
            {
                while (datareader.Read())
                {
                    Console.WriteLine("{0,-15} | {1,-15} | {2,-15} | {3,-15} | {4,-15} | {5,-15} | {6,-15} | {7,-15} | {8,-15}", datareader[0], datareader[1], datareader[2], datareader[3], datareader[4], datareader[5], datareader[6], datareader[7], datareader[8]);
                }
            }
            else
            {
        ...
        public void Pioneer_D_Group_Match_With_DuPont(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine(" ## We are having the records in 'Pioneer_D_Group_Match_With_DuPont' please validate Manually ## ");
            }
        ...
        public void Potential_Duplicates_with_potential_match(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine(" ## We are having the records in the 'Potential_Duplicates_with_potential_match' please validate Manually ## ");
            }
        ...
        public void MyAccessID_Duplicates(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine(" ## We are having the records  in the 'MyAccessID_Duplicates' please validate Manually ## ");
            }
        ...
        public void Removal_Not_In_Duplicate_Tables(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine(" ## We are having the records in the 'Removal_Not_In_Duplicate_Tables' please validate Manually ## ");
            }
        ...
        public void Email_Duplicates(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine(" ## We are having the records in the 'Email_Duplicates' please validate Manually ## ");
            }
        ...
        public void Add_Delete_Expatriates(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine(" ## We are having the records in the 'Add_Delete_Expatriates' please validate Manually ## ");
            }
        ...
        public void New_Expatriates(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine(" ## We are having the records in the 'New_Expatriates' please validate Manually ## ");
            }
        ...
        public void Removed_Expatriates(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine(" ## We are having the records in the 'Removed_Expatriates' please validate Manually ## ");
            }
