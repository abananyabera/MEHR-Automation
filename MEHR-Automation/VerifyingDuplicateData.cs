...
namespace MEHR_Automation
{
    public class VerifyingDuplicateData
    {
        ...
        public void reverifyDuplicates(SqlConnection sqlconnection)
        {
            ...
            {
                Console.WriteLine("\n Not Returning Empty results in current Executing Query");
                Console.WriteLine("\n PLEASE VALIDATE MANUALLY HERE ");
                ReadLine();
            }
            ...
            else
            {
                while (datareader3.Read())
                {
                    ...
                    {
                        Console.WriteLine("{0,-15} | {1,-15} | {2,-15} | {3,-15} | {4,-15} | {5,-15} | {6,-15} | {7,-15} | {8,-15} | {9,-15} | {10,-15}}", selectQuery_datareader[0], selectQuery_datareader[3], selectQuery_datareader[4], selectQuery_datareader[5], selectQuery_datareader[6], selectQuery_datareader[7], selectQuery_datareader[8], selectQuery_datareader[23], selectQuery_datareader[24], selectQuery_datareader[28], selectQuery_datareader[29]);
                        if (count == 0)
                        {
